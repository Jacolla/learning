...
class GetRoom(APIView):
    ...
    def get(
    ...
    ):  # BackEnd para comprobar si hay room con esos datos, para asi cogerlo y enviarlo a room.js y montar la room
        ...
        if code != None:
            ...
            return Response(
                {"Room Not Founds": "Invalid Room Code"},
...
class JoinRoom(APIView):
    ...
    def post(self, request, format=None):
        ...
        if code != None:
            ...
            if len(room_result) > 0:
                ...
                self.request.session[
                    "room_code"
                ] = code  # Para comprobar que usuarios hay en esta room
        ...
        return Response(
            {"Bad Request": "Invalid post data, did not find key"},
            status=status.HTTP_400_BAD_REQUEST,
        )
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if queryset.exists():
                ...
                self.request.session[
                    "room_code"
                ] = room.code  # Para comprobar que usuarios hay en esta room
    ...
    def patch(self, request, format=None):  # --patch--  para modificar/actualizar data
        ...
        if serializer.is_valid():
            ...
            if room.host != user_id:
                return Response(
                    {"msg": "You are not the host! Bitch"},
